                                    ...
                                    <a href="/Yolo/view/lot/LotView.jsp" class="propWidget-1" style="margin-bottom: 5px;">
                                        ...
                                        <div class="fig">
                                            ...
                                            <div class="figCap">
                                              ...
                                              <button style="float:right; margin: 5px;" href="#" class="btn btn-o btn-green">요청취소</button>
                                    </a>
                             ...
                             <div class="col-md-4 col-sm-6">
                                    <a href="/Yolo/view/lot/LotView.jsp" class="propWidget-1" style="margin-bottom: 5px;">
                                        ...
                                        <div class="fig">
                                            ...
                                            <div class="priceCap"><span>2,000원/시간</span></div>
                                            <div class="figCap">
                                                <h3>윙스터디 강남역점</h3>
                                                <div class="address">강남</div>
                                                <div class="feat feat-1"><span class="fa fa-eye"></span> 15</div>
                                                <div class="feat feat-2"><span class="icon-bubble"></span> 	11</div>                                               
                                            </div>
                                        </div>
