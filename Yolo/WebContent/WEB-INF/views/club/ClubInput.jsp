...
<link href="/Yolo/css/jquery.tagsinput.css" rel="stylesheet">
			...
			<div class="home-wrapper">
				...
				<form class="form-horizontal" role="form" method="post" action="/Yolo/club/ClubInputOk.club">
...
<!-- 										<li class="active"><input type="radio" name="c_date" checked="checked" value="00:00"><a href="#">오전 12:00</a></li> -->
