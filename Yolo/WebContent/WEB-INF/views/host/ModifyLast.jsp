							...
							<div class="col-sm-3">
								<div class="btn-group">
									...
									<ul id="lec_timeselec" class="dropdown-menu dropdown-select">
										...
										<li <% if(pri_weekendes[0]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[0]==1){ %> selected <%} %> value="08:00"><a href="#">오전 08:00</a></li>
										<li <% if(pri_weekendes[1]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[1]==1){ %> selected <%} %> value="09:00"><a href="#">오전 09:00</a></li>
									    <li <% if(pri_weekendes[2]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[2]==1){ %> selected <%} %>  value="10:00"><a href="#">오전 10:00</a></li>
										<li <% if(pri_weekendes[3]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[3]==1){ %> selected <%} %>  value="11:00"><a href="#">오전 11:00</a></li>
										<li <% if(pri_weekendes[4]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[4]==1){ %> selected <%} %>  value="12:00"><a href="#">오후 12:00</a></li>
									    <li <% if(pri_weekendes[5]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[5]==1){ %> selected <%} %>  value="13:00"><a href="#">오후 01:00</a></li>
										<li <% if(pri_weekendes[6]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[6]==1){ %> selected <%} %>  value="14:00"><a href="#">오후 02:00</a></li>
										<li <% if(pri_weekendes[7]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[7]==1){ %> selected <%} %>  value="15:00" selected="selected"><a href="#">오후 03:00</a></li>
										<li <% if(pri_weekendes[8]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[8]==1){ %> selected <%} %>  value="16:00"><a href="#">오후 04:00</a></li>
										<li <% if(pri_weekendes[9]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[9]==1){ %> selected <%} %>  value="17:00"><a href="#">오후 05:00</a></li>
								    	<li <% if(pri_weekendes[10]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[10]==1){ %> selected <%} %>  value="18:00"><a href="#">오후 06:00</a></li>
										<li <% if(pri_weekendes[11]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[11]==1){ %> selected <%} %>  value="19:00"><a href="#">오후 07:00</a></li>
										<li <% if(pri_weekendes[12]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[12]==1){ %> selected <%} %>  value="20:00"><a href="#">오후 08:00</a></li>
										<li <% if(pri_weekendes[13]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[13]==1){ %> selected <%} %>  value="21:00"><a href="#">오후 09:00</a></li>
										<li <% if(pri_weekendes[14]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[14]==1){ %> selected <%} %>  value="22:00"><a href="#">오후 10:00</a></li>
										<li <% if(pri_weekendes[15]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekdaye" <% if(pri_weekendes[15]==1){ %> selected <%} %>  value="23:00"><a href="#">오후 11:00</a></li>
							...
							<div class="col-sm-3">
								<div class="btn-group">
									...
									<ul id="lec_timeselec" class="dropdown-menu dropdown-select">
										...
										<li <% if(pri_weekendes[0]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[0]==1){ %> selected <%} %> value="08:00"><a href="#">오전 08:00</a></li>
										<li <% if(pri_weekendes[1]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[1]==1){ %> selected <%} %> value="09:00"><a href="#">오전 09:00</a></li>
									    <li <% if(pri_weekendes[2]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[2]==1){ %> selected <%} %>  value="10:00"><a href="#">오전 10:00</a></li>
										<li <% if(pri_weekendes[3]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[3]==1){ %> selected <%} %>  value="11:00"><a href="#">오전 11:00</a></li>
										<li <% if(pri_weekendes[4]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[4]==1){ %> selected <%} %>  value="12:00"><a href="#">오후 12:00</a></li>
									    <li <% if(pri_weekendes[5]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[5]==1){ %> selected <%} %>  value="13:00"><a href="#">오후 01:00</a></li>
										<li <% if(pri_weekendes[6]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[6]==1){ %> selected <%} %>  value="14:00"><a href="#">오후 02:00</a></li>
										<li <% if(pri_weekendes[7]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[7]==1){ %> selected <%} %>  value="15:00" selected="selected"><a href="#">오후 03:00</a></li>
										<li <% if(pri_weekendes[8]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[8]==1){ %> selected <%} %>  value="16:00"><a href="#">오후 04:00</a></li>
										<li <% if(pri_weekendes[9]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[9]==1){ %> selected <%} %>  value="17:00"><a href="#">오후 05:00</a></li>
								    	<li <% if(pri_weekendes[10]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[10]==1){ %> selected <%} %>  value="18:00"><a href="#">오후 06:00</a></li>
										<li <% if(pri_weekendes[11]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[11]==1){ %> selected <%} %>  value="19:00"><a href="#">오후 07:00</a></li>
										<li <% if(pri_weekendes[12]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[12]==1){ %> selected <%} %>  value="20:00"><a href="#">오후 08:00</a></li>
										<li <% if(pri_weekendes[13]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[13]==1){ %> selected <%} %>  value="21:00"><a href="#">오후 09:00</a></li>
										<li <% if(pri_weekendes[14]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[14]==1){ %> selected <%} %>  value="22:00"><a href="#">오후 10:00</a></li>
										<li <% if(pri_weekendes[15]==1){ %> class="active" <%} %> ><input type="radio" name="pri_weekende" <% if(pri_weekendos[15]==1){ %> selected <%} %>  value="23:00"><a href="#">오후 11:00</a></li>
				...
				<div>
					<div style="text-align: center;">
						...
						<div style="display: inline-block;">
							<button id="btn_register" class="btn btn-o btn-green">수정하기</button>
						</div>
					</div>
				</div>
...
<script>
	$(function(){
		$("#btn_register").click(function(){
			$('form').attr('action','/Yolo/host/LotModifyFinish.host')
			$(this).submit();
		});
	});
</script>
